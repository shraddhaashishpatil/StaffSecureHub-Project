...
const EmpRegisterForm = () => {

    const { register, handleSubmit, formState : { errors }, setError } = useForm()

    const onSubmit = async (data) => {
        try{
            const response = await Emp.create(data);
            console.log(data);
                        ...
                        <div className="col-md-10">
                            <form className="form-m-t" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <input {...register("phoneNumber", {required: "Phone Number is required", pattern: { value: /^\d{10}$/,
                                        message: "Invalid phone number format"} })} className="input-hw" type="tel" placeholder="phoneNumber *" />
                                ...
                                <div className="text-center"> 
                                    ...
                                    &nbsp;&nbsp;
                                    <button type="submit" className="btn btn-info" onClick={handleShowData}>Show Data</button>
                                </div>
                            </form>
                        </div>
                        <div className="col-md-1"></div>
